...
import imageBackground from "../../../public/heroPortada.jpg"
        ...
        <div className="min-h-screen">
            <div className="relative w-full h-[400px]">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                    <h1 className={`${poppins.className} text-outline text-3xl md:text-9xl font-bold text-white`}>MOND</h1>
            ...
            <div className="flex flex-col-reverse md:flex-row w-full max-w-[1500px] mx-auto justify-center items-center gap-4 md:gap-0">
                <div className="w-1/2 flex items-center flex-col border-r-0 md:border-r-2 border-white">
                    <h2 className={`${poppins.className} text-outline text-3xl md:text-3xl font-bold text-white`}>Contactanos</h2>
                ...
                <div className="w-1/2 flex items-center flex-col p-3 gap-3">
                    <h2 className={`${poppins.className} text-outline text-3xl md:text-3xl font-bold text-white`}>Donde nos encontramos</h2>
                    <iframe
